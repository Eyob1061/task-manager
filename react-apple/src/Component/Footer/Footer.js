...
import sixten from '../../images/icons/16.png'
        ...
        <footer className="footer-wrapper">
            <div className="container"> 
                <div className="upper-text-container">
                    ...
                    <p>2. Subscription required.</p><br/><br/>
                   <p> Magic Keyboard sold separately.<br/><br/>
                ...
                <div className="copyright-wrapper row">
                    ...
                    <div className="footer-country  col-sm-12 order-1 col-md-4 order-md-2 text-md-right col-lg-2 order-lg-3">
                        <div className="flag-wrapper"><img src={sixten} /></div> <div className="footer-country-name">United States</div> 
                    </div>
                </div>
            </div>
	</footer> 
